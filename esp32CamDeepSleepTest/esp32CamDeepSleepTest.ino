...
// Wifi SSID info
const char* WIFI_SSID = "Casa Monts & Bails"; //ICT-LAB 
const char* WIFI_PASSWORD = "monty@140AB"; 

// Firebase project Storage Bucket ID 
const char* FIREBASE_STORAGE_BUCKET_ID = "foodpackage-3f995.firebasestorage.app";

#define CAPTURE_INTERVAL 60 //in seconds
...
int takeAndUploadPhoto() {
  ...
  HTTPClient http;
  String imageName = "picture-A" + String(photoCount) + ".jpeg";
